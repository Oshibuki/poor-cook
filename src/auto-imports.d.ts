...
declare global {
  ...
  const useInventoryStore: typeof import('./store/inventory')['useInventoryStore']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useInventoryStore: UnwrapRef<typeof import('./store/inventory')['useInventoryStore']>
