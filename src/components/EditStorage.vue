...
onMounted(() => {
  ...
  if (currentItem) {
    ...
    ruleForm.name = [currentItem.category, currentItem.name]
    ruleForm.description = currentItem.description
    ruleForm.packagingDate = new Date(currentItem.packagingDate)
...
const handleNameChange = function (value: string[]) {
  ruleForm.name = value
}
  ...
  <el-row justify="center">
    <el-col :xs="24" :md="6">
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" @click.stop="saveItem">
            保存
          </el-button>
          <el-button type="primary" @click.stop="deleteItem">
            删除
          </el-button>
        </el-form-item>
      </el-form>
